...
#[repr(u8)] // u4 would be sufficient but it does not exist in Rust
pub enum Color {
    Black = 0,
    Blue = 1,
    Green = 2,
...
#[macro_export]
macro_rules! print {
    ($($arg:tt)*) => ($crate::vga_buffer::vga_buffer::_print(format_args!($($arg)*)));
}
...
pub fn _remove_last() {
    use x86_64::instructions::interrupts;
    interrupts::without_interrupts(|| {
        WRITER.lock().remove_last();
    });
}

#[test_case]
fn test_println_simple_should_not_panic() {
    println!("test_println_simple output");
}

#[test_case]
fn test_println_many_should_not_panic() {
    for _ in 0..200 {
